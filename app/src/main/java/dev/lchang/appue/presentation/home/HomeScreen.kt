                ...
                Card(
                    ...
                    Row(modifier = Modifier.padding(12.dp)) {
                        Image(
                            ...
                            //contentScale = ContentScale.Crop,  // El escalado, es para redimensional la iamgen de acuerdo a tu fials o size
                            painter = rememberAsyncImagePainter(country.imageUrl)
                        )
                        Spacer(modifier = Modifier.width(12.dp)) // puede ser 8 o 12 par que no se vea pegado entre las iamgenes
                        Column{
